...
#change depending on file path
df = pd.read_excel(r"C:\Users\Afolabi\OneDrive - The Pennsylvania State University\Excel Training\ExcelGrind\Case Study\Submit\Analysis.xlsx", sheet_name= "ValuationData", skiprows=6, usecols= ['Date', 'Minimum', 'Median', 'Mean', 'Maximum'])
